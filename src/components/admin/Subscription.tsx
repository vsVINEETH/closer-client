    ...
    useEffect(() => {
       setResult(
          searchValue ? filterData.filter(category =>
            category.planType.toLowerCase().includes(searchValue.toLowerCase()) 
          ): filterData
        )
...
//filter
    ...
    const handleFilter = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const filtered = subscriptionData.filter((subs) => {
            // Clone dates to avoid mutation
            const categoryDate = new Date(subs.createdAt);
            ...
            const isStatusMatch = status === undefined || subs.isListed === status;
    ...
    const removeFilter = () => {
        ...
        setFilterData(subscriptionData);
    }
  ...
  return (
    ...
    <div className="relative flex flex-col w-full h-full text-gray-700 bg-white dark:bg-nightBlack dark:text-lightGray  bg-clip-border ">
        ...
        <table className="w-full mt-4 text-left table-auto min-w-max">
            ...
            <th
                ...
                <p
                    className="flex items-center justify-between gap-2 font-sans text-sm antialiased font-normal leading-none text-blue-gray-900 opacity-70">
                    Plan Type
                    <ChevronsUpDown size={13} onClick={() => handleSort('planType')}/>
                </p>
                </th>
                <th
                className="p-4 transition-colors cursor-pointer border-y border-blue-gray-100 bg-blue-gray-50/50 hover:bg-blue-gray-50">
                <p
                    className="flex items-center justify-between gap-2 font-sans text-sm antialiased font-normal leading-none text-blue-gray-900 opacity-70">
                        Price
                    <ChevronsUpDown size={13} onClick={() => handleSort('price')}/>
                </p>
                </th>
                <th
                className="p-4 transition-colors cursor-pointer border-y border-blue-gray-100 bg-blue-gray-50/50 hover:bg-blue-gray-50">
            ...
            <td className="p-4">
                ...
                <button
                    ...
                    type="button"
                    onClick={() => handleListing(value._id)}
                    >
                        {!value.isListed ? 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 transition-opacity">
            ...
            <h2 className="text-lg font-bold mb-4 text-darkGray">Edit Subscription</h2>
            <form onSubmit={handleEditSubmit}>
                <div className="mb-4">
                <label className="block text-sm font-medium mb-1 text-nightBlack">price</label>
                <input
                    type="text"
                    name='price'
